        ...
        <div class="tabs-container">
            <div class="row" style="margin-top:10px;">
                ...
                <div class="col-lg-4 text-right">
                    <!--<select class="form-control" onchange="location.href = 'index.php?controller=products&action=categories&catid=<?php echo $catid; ?>&findPrice='+this.value;">
                ...
                <div class="col-lg-3 text-right">
                    <select class="form-control" onchange="location.href = 'index.php?controller=products&action=categories&catid=<?php echo $catid; ?>&orderBy='+this.value;">
                ...
                <div class="col-lg-2">
                    <select class="form-control" onchange="location.href = 'index.php?controller=products&action=categories&catid=<?php echo $catid; ?>&recordPerPage='+this.value;">
                ...
                <?php endforeach; ?>
                    ...
                    <div class="&#x70;&#x61;&#x67;&#x69;&#x6E;&#x61;&#x74;&#x69;&#x6F;&#x6E;&#x2D;&#x63;&#x6F;&#x6E;&#x74;&#x61;&#x69;&#x6E;&#x65;&#x72;">
                        <ul class="pagination">
                            ...
                            <li class="page-item"><a href="index.php?controller=productss&action=categories&catid=<?php echo $catid ?>&p=<?php echo $i; ?>" class="page-link"><?php echo $i; ?></li>
                            <?php endfor; ?>
                        </ul></div>
                    <!-- end paging -->
                </div>
