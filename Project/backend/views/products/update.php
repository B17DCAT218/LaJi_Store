...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <?php
            ...
            if (isset($_POST['hot'])){
                $checkbox_hot = 'selected';
            }
            if (isset($_POST['new'])){
                $checkbox_new = 'selected';
            }
        ?>
        <input type="radio" name="hot" id="hot" <?php echo $radio_hot ?> >
        <label for="hot">Hot</label>
        <input type="radio" name="hot" id="hot" <?php echo $radio_new ?> >
        <label for="hot">New</label>
    </div>
    <div class="form-group">
